...
class QCFace(nn.Module):
    def __init__(self,
        ...
        self.eps = 1e-3
        self.num_quantized_value = 10
        self.quantized_step = self.ua//self.num_quantized_value
    ...
    def get_proxy(self, labels):
        return self.weight[:, labels].clone().detach().transpose(-2, -1)

    def get_easy_probs(self, embeds, labels):
        # Get normalize
        ...
        easy_probs = (cos_theta*self.scale).softmax(dim=1) # [N, embed_size]
