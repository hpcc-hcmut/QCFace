...
import heapq
import math
from similarity import identification_similarity as sim_fnc
...
def evaluation(query_feats, 
    ...
    similarity = sim_fnc(query_feats, gallery_feats, similarity_method, loss_model)
